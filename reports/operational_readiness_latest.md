...
| --- | --- | --- | ---: | ---: | --- |
| `ai_high_density` | `L4` | `L5` | 1 | 86.091 | otel-core, qso-readiness |
| `compliance` | `L4` | `L4` | 0 | 81.667 | terraform-plan |
| `compute` | `L4` | `L5` | 1 | 122.54 | otel-core, redfish-hardware, terraform-plan |
| `cooling` | `L4` | `L5` | 1 | 98.572 | facility-bms, redfish-hardware |
| `disaster_recovery` | `L4` | `L5` | 1 | 39.781 | market-exchange, qso-readiness |
| `energy` | `L4` | `L4` | 0 | 67.183 | facility-bms, sustainability-xue |
| `facility` | `L4` | `L5` | 1 | 73.572 | facility-bms, terraform-plan |
| `finance` | `L4` | `L4` | 0 | 65.278 | market-exchange, sustainability-xue |
| `market` | `L4` | `L4` | 0 | 61.667 | market-exchange |
| `network` | `L4` | `L5` | 1 | 122.54 | otel-core, redfish-hardware, terraform-plan |
| `power` | `L4` | `L5` | 1 | 98.572 | facility-bms, redfish-hardware |
| `qso` | `L4` | `L4` | 0 | 17.895 | qso-readiness |
| `security` | `L4` | `L5` | 1 | 117.977 | otel-core, terraform-plan |
| `storage` | `L4` | `L5` | 1 | 122.54 | otel-core, redfish-hardware, terraform-plan |
